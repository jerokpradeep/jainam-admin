      ...
      <div class="card p-4 h-full">
        <div class="mb-6 gap-2 grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-6">
          <div>
            ...
            <input v-model="symbol" class="border w-full h-10 rounded focus:outline-0 px-4 text-xs" />
          </div>
          <div>
            <p class="primaryColor pb-1 text-sm">Exchange</p>
            <select v-model="selectedExchangeData" class="border w-full h-10 rounded focus:outline-0 px-4 text-xs">
