<template>
  <div class="p-5" v-if="tabCondition == false">
    <ul
      role="list"
      class="grid gap-6 grid-cols-2 sm:grid-cols-4 max-w-[1152px]"
    >
      <li
        ...
        :key="id"
        :class="{ 'bg-[#F9FDFF] border-[0.1px] border-[#c4daff]': i.active }"
      >
        <div
  ...
  <div v-if="tabCondition == true">
    <div class="p-5">
      <button
        v-on:click="tabCondition = false"
        type="button"
