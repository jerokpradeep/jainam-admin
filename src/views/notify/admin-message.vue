                ...
                <div class="col-span-5 bg-white pl-[20px]">
                    <div class="mb-5 flex flex-col">
                        ...
                        <div class="mt-4" v-if="userType == 'individual'">
                            <div class="pb-1 text-sm">User ID <span class="ml-5 text-xs">( Ex: 10234,12049,76543 )</span>
                            </div>
                            <input type="text" class="border w-full h-10 rounded focus:outline-0 px-4 max-w-[350px] text-xs"
                                v-model="userId">
                        ...
                        <div>
                            ...
                            <textarea id="adminMsg" rows="5"
                                class="border w-full rounded focus:outline-0 p-2 max-w-[350px] text-xs" v-model="message"
                                placeholder="Enter the template message"></textarea>
